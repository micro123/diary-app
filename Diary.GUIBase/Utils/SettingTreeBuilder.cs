...
{
    public static void BuildTree(SettingGroup tree, object o, BaseApp app)
    {
        var type = o.GetType();
        ...
        foreach (var property in properties)
        {
            ...
            switch (cfg)
            {
                case ConfigureGroupAttribute g:
                    ...
                    BuildTree(group, property.GetValue(o)!, app);
                    item = group;
                    break;
                ...
                case ConfigureUserAttribute u:
                    item = app.CreateModelFor(u.Caption, u.HelpTip, u.Key, o, property);
                    break;
