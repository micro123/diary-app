    ...
    : EditableItemModel(title, helpTip, o, p, EnsureString)
{
    ...
    {
        Value = (string)Prop.GetValue(Obj)!;
        DirName = Path.GetDirectoryName((string?)Value) ?? "";
    }
    ...
    : EditableItemModel(title, helpTip, o, p, EnsureInteger)
{
    ...
    protected override void SaveAction()
    {
        ...
        try
        {
            ...
            {
                case TypeCode.SByte: value = Convert.ToSByte((long)Value); break;
                case TypeCode.Byte: value = Convert.ToByte((long)Value); break;
                case TypeCode.Int16: value = Convert.ToInt16((long)Value); break;
                case TypeCode.UInt16: value = Convert.ToUInt16((long)Value); break;
                case TypeCode.Int32: value = Convert.ToInt32((long)Value); break;
                case TypeCode.UInt32: value = Convert.ToUInt32((long)Value); break;
                case TypeCode.Int64: value = Convert.ToInt64((long)Value); break;
                case TypeCode.UInt64: value = Convert.ToUInt64((long)Value); break;
            }
        }
        catch (Exception)
        {
