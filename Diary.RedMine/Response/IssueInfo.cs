...
public class IssueInfo
{
    ...
    public CommonInfo Tracker { get; set; } = new();
    [JsonProperty("status")]
    public CommonInfo Status { get; set; } = new();
    [JsonProperty("priority")]
    public CommonInfo Priority { get; set; } = new();
    [JsonProperty("author")]
    public CommonInfo Author { get; set; } = new();
    [JsonProperty("assigned_to")]
    public CommonInfo AssignedTo { get; set; } = new();
