...
日期：2026-08-24
- 日记页左侧日历收敛为固定一周视图：左右箭头、PageUp/PageDown 和鼠标滚轮均逐周浏览，点击月份标题打开加高的完整月历；上下文操作移到周历外层，紧凑日期提供日/周/上周操作与脚本，右键非选中日期会同时选中并打开菜单，今天使用圆形浅色强调底与描边，当前选中使用圆形主色高亮背景，两种状态可叠加；月份标题提供月/季度/年度操作与脚本，完整月历仅负责日期选择和年月定位，并按模板自然尺寸完整显示四周边框；跨月后“回到今天”仍可恢复当前周。
