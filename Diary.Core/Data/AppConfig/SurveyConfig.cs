...
public class SurveyConfig
{
    ...
    [ConfigureSwitch("作为调查者", helpTip: "调查者展示调查页面、向受访者发起调查，并通过本机地址接收自己的调查结果；不需要填写调查者 IP 地址。")]
    ...
    {
        address = IsServerEnabled ? "127.0.0.1" : ServerAddress.Trim();
        return Enabled && address.Length > 0;
    }
}
